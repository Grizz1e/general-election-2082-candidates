...
* Full CSV is located inside /data/candidates.csv
* JSON file is also provided for easier integration in your project
* State wise CSV and JSON files are also provided along with the mapping data
* In /data/districts.json, parentId represents the State it belongs to
